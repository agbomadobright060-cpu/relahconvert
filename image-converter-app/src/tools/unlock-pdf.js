...
const selectLbl = t.unlkpdf_select || t.pdfpng_select || 'Select PDFs'
const dropHint  = t.unlkpdf_drop_hint || t.pdfpng_drop_hint || 'or drop PDFs anywhere'
...
document.title = t.unlkpdf_page_title || 'Unlock PDF Free | Remove PDF Password Online \u2014 RelahConvert'
