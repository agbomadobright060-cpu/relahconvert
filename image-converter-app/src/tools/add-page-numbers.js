...
document.querySelector('#app').innerHTML = `
  <div style="max-width:900px;margin:32px auto;padding:0 16px 60px;font-family:'DM Sans',sans-serif;">
    ...
    <label for="fileInput" id="dropZone" class="drop-zone">
      ...
      <span style="font-size:14px;color:var(--text-secondary);margin-top:10px;font-family:'DM Sans',sans-serif;font-weight:600;">${t.addpgnum_drop_pdf || 'Drop a PDF here'}</span>
    </label>
