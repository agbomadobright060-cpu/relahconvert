// Word → PDF tool: bulk processing of up to 10 .docx/.doc files per session
// via the shared bulk-pdf engine. CloudConvert routing happens through the
// Pages Function broker at /api/convert/word-to-pdf/{start,status}.
