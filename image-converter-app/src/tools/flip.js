...
style.textContent = `
  ...
  .card-img-wrap{position:relative;width:100%;height:130px;display:flex;align-items:center;justify-content:center;background:var(--bg-surface);border-radius:10px 10px 0 0;overflow:hidden;}
  ...
  .card-flip-btn{flex:1;padding:6px 4px;border:1.5px solid var(--border-light);border-radius:8px;background:var(--bg-card);font-size:11px;font-weight:600;color:var(--text-secondary);font-family:'DM Sans',sans-serif;cursor:pointer;transition:all 0.15s;text-align:center;}
  .card-flip-btn:hover{border-color:var(--accent);color:var(--accent);}
  .card-flip-btn.active{border-color:var(--accent);background:var(--accent-bg);color:var(--accent);}
  .card-fname{font-size:11px;color:var(--text-secondary);font-family:'DM Sans',sans-serif;padding:2px 8px 2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center;}
  .card-status{font-size:10px;color:var(--text-muted);font-family:'DM Sans',sans-serif;text-align:center;min-height:14px;padding:0 8px;}
  .card-dl{display:none;font-size:11px;font-weight:700;color:var(--accent);font-family:'DM Sans',sans-serif;padding:2px 8px 0;text-align:center;text-decoration:none;}
...
zipBtn.addEventListener('click', async () => {
  ...
  try {
    ...
    window.rcShowSaveButton?.(zipBtn.parentElement, zipBlob, 'flipped-images.zip', 'flip')
