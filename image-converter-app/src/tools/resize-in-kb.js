...
const seoResizeKB = {
  ...
  fr: {
    ...
    steps: ['<strong>Téléchargez votre image</strong> — cliquez sur « Sélectionner une image » ou glissez-déposez un fichier JPG, PNG ou WebP.','<strong>Entrez la taille cible</strong> — tapez la taille de fichier souhaitée en kilo-octets (par ex. 100 Ko, 200 Ko).','<strong>Cliquez sur Redimensionner</strong> — l\'outil compresse pour atteindre votre cible. Si la cible est supérieure à l\'original, il enregistre en qualité maximale.','<strong>Téléchargez</strong> — enregistrez l\'image redimensionnée sur votre appareil.'],
    h2b: 'Meilleur outil gratuit pour compresser une image à une taille en Ko exacte',
    body: '<p>Besoin d\'une image de moins de 100 Ko pour soumettre un formulaire ? Ou exactement 200 Ko pour une photo de visa ? L\'outil Redimensionner en Ko de RelahConvert utilise une compression intelligente par recherche binaire pour atteindre la taille de fichier cible aussi précisément que possible — le tout dans votre navigateur. Aucun téléversement, aucun serveur, entièrement gratuit.</p><p>L\'outil gère automatiquement trois scénarios : si votre cible est inférieure à l\'original, il compresse pour correspondre. Si la cible est supérieure, il ré-encode en qualité JPEG maximale. Si l\'image est déjà proche de la taille cible, il télécharge l\'original. Fonctionne parfaitement pour les exigences de taille de photo de passeport, les limites de téléversement des formulaires gouvernementaux, les restrictions de pièces jointes par e-mail, et toute situation où vous avez besoin d\'une image à une taille spécifique en kilo-octets.</p>',
  ...
  es: {
    ...
    steps: ['<strong>Sube tu imagen</strong> — haz clic en "Seleccionar imagen" o arrastra y suelta un archivo JPG, PNG o WebP.','<strong>Ingresa el tamaño objetivo</strong> — escribe el tamaño de archivo que deseas en kilobytes (por ej. 100 KB, 200 KB).','<strong>Haz clic en Redimensionar</strong> — la herramienta comprime para alcanzar tu objetivo. Si el objetivo es mayor que el original, guarda en calidad máxima.','<strong>Descarga</strong> — guarda la imagen redimensionada en tu dispositivo.'],
    h2b: 'Mejor herramienta gratuita para comprimir una imagen a un tamaño exacto en KB',
    body: '<p>¿Necesitas una imagen de menos de 100 KB para enviar un formulario? ¿O exactamente 200 KB para una foto de visa? La herramienta Redimensionar en KB de RelahConvert usa compresión inteligente de búsqueda binaria para alcanzar el tamaño de archivo objetivo con la mayor precisión posible — todo dentro de tu navegador. Sin subir archivos, sin servidor, completamente gratis.</p><p>La herramienta maneja tres escenarios automáticamente: si tu objetivo es menor que el original, comprime para coincidir. Si el objetivo es mayor, re-codifica en calidad JPEG máxima. Si la imagen ya está cerca del tamaño objetivo, descarga el original. Funciona perfectamente para requisitos de tamaño de foto de pasaporte, límites de carga de formularios gubernamentales, restricciones de archivos adjuntos en correos electrónicos, y cualquier situación donde necesites una imagen a un tamaño específico en kilobytes.</p>',
  ...
  de: {
    ...
    steps: ['<strong>Bild hochladen</strong> — klicken Sie auf „Bild auswählen" oder ziehen Sie eine JPG-, PNG- oder WebP-Datei per Drag & Drop.','<strong>Zielgröße eingeben</strong> — geben Sie die gewünschte Dateigröße in Kilobyte ein (z. B. 100 KB, 200 KB).','<strong>Klicken Sie auf Ändern</strong> — das Tool komprimiert, um Ihr Ziel zu erreichen. Wenn das Ziel größer als das Original ist, speichert es in maximaler Qualität.','<strong>Herunterladen</strong> — speichern Sie das verkleinerte Bild auf Ihrem Gerät.'],
    h2b: 'Bestes kostenloses Tool zum Komprimieren eines Bildes auf eine exakte KB-Größe',
    body: '<p>Brauchen Sie ein Bild unter 100 KB für eine Formulareinreichung? Oder genau 200 KB für ein Visafoto? Das KB-Größenänderungs-Tool von RelahConvert verwendet intelligente Binärsuche-Komprimierung, um Ihre Zieldateigröße so genau wie möglich zu erreichen — alles in Ihrem Browser. Kein Upload, kein Server, völlig kostenlos.</p><p>Das Tool behandelt automatisch drei Szenarien: Wenn Ihr Ziel kleiner als das Original ist, komprimiert es entsprechend. Wenn das Ziel größer ist, kodiert es in maximaler JPEG-Qualität neu. Wenn das Bild bereits nahe an der Zielgröße liegt, wird das Original heruntergeladen. Funktioniert perfekt für Passbildgrößenanforderungen, Upload-Limits bei Behördenformularen, E-Mail-Anhangsbeschränkungen und jede Situation, in der Sie ein Bild in einer bestimmten Kilobyte-Größe benötigen.</p>',
  ...
  ar: {
    ...
    steps: ['<strong>ارفع صورتك</strong> — انقر على "اختيار صورة" أو اسحب وأفلت ملف JPG أو PNG أو WebP.','<strong>أدخل الحجم المطلوب</strong> — اكتب حجم الملف الذي تريده بالكيلوبايت (مثلاً 100 كيلوبايت، 200 كيلوبايت).','<strong>انقر تغيير الحجم</strong> — الأداة تضغط للوصول إلى هدفك. إذا كان الهدف أكبر من الأصلي، تحفظ بأقصى جودة.','<strong>حمّل</strong> — احفظ الصورة المُعدَّلة على جهازك.'],
    h2b: 'أفضل أداة مجانية لضغط الصورة إلى حجم محدد بالكيلوبايت',
    body: '<p>هل تحتاج صورة أقل من 100 كيلوبايت لتقديم نموذج؟ أو بالضبط 200 كيلوبايت لصورة تأشيرة؟ أداة تغيير الحجم بالكيلوبايت من RelahConvert تستخدم ضغطاً ذكياً بالبحث الثنائي للوصول إلى حجم الملف المستهدف بأكبر دقة ممكنة — كل ذلك داخل متصفحك. بدون رفع، بدون خادم، مجاني بالكامل.</p><p>الأداة تتعامل مع ثلاثة سيناريوهات تلقائياً: إذا كان هدفك أصغر من الأصلي، تضغط للمطابقة. إذا كان الهدف أكبر، تعيد الترميز بأقصى جودة JPEG. إذا كانت الصورة قريبة بالفعل من الحجم المستهدف، تحمّل الأصلي. تعمل بشكل مثالي لمتطلبات حجم صورة جواز السفر، وحدود رفع نماذج الجهات الحكومية، وقيود مرفقات البريد الإلكتروني، وأي حالة تحتاج فيها إلى صورة بحجم محدد بالكيلوبايت.</p>',
  ...
  ja: {
    ...
    steps: ['<strong>画像をアップロード</strong> — 「画像を選択」をクリックするか、JPG、PNG、またはWebPファイルをドラッグ＆ドロップしてください。','<strong>目標サイズを入力</strong> — 希望するファイルサイズをキロバイトで入力してください（例：100 KB、200 KB）。','<strong>リサイズをクリック</strong> — ツールが目標サイズに合わせて圧縮します。目標がオリジナルより大きい場合は、最高品質で保存します。','<strong>ダウンロード</strong> — リサイズされた画像をデバイスに保存してください。'],
    h2b: '画像を正確なKBサイズに圧縮する最高の無料ツール',
    body: '<p>フォーム送信用に100 KB以下の画像が必要ですか？ビザ写真用にちょうど200 KBが必要ですか？RelahConvertのKBリサイズツールは、スマートなバイナリサーチ圧縮を使用して、目標ファイルサイズにできるだけ近づけます — すべてブラウザ内で完結。アップロード不要、サーバー不要、完全無料です。</p><p>このツールは3つのシナリオを自動的に処理します：目標がオリジナルより小さい場合は圧縮して合わせます。目標が大きい場合は、最高JPEG品質で再エンコードします。画像が既に目標サイズに近い場合は、オリジナルをそのままダウンロードします。パスポート写真のサイズ要件、政府フォームのアップロード制限、メール添付の容量制限など、特定のキロバイトサイズの画像が必要なあらゆる場面で完璧に機能します。</p>',
  ...
  ru: {
    ...
    steps: ['<strong>Загрузите изображение</strong> — нажмите «Выбрать изображение» или перетащите файл JPG, PNG или WebP.','<strong>Введите целевой размер</strong> — укажите желаемый размер файла в килобайтах (например, 100 КБ, 200 КБ).','<strong>Нажмите Изменить</strong> — инструмент сжимает изображение до целевого размера. Если целевой размер больше оригинала, изображение сохраняется с максимальным качеством.','<strong>Скачайте</strong> — сохраните изменённое изображение на устройство.'],
    h2b: 'Лучший бесплатный инструмент для сжатия изображения до точного количества КБ',
    body: '<p>Нужно изображение менее 100 КБ для отправки формы? Или ровно 200 КБ для визовой фотографии? Инструмент RelahConvert «Размер в КБ» использует умное сжатие с бинарным поиском, чтобы максимально точно достичь целевого размера файла — полностью в вашем браузере. Без загрузки на сервер, без регистрации, полностью бесплатно.</p><p>Инструмент автоматически обрабатывает три сценария: если целевой размер меньше оригинала, он сжимает до нужного размера. Если целевой размер больше, изображение перекодируется с максимальным качеством JPEG. Если изображение уже близко к целевому размеру, скачивается оригинал. Идеально подходит для требований к размеру фото на паспорт, ограничений загрузки на государственных порталах, лимитов вложений электронной почты и любых ситуаций, когда вам нужно изображение определённого размера в килобайтах.</p>',
  ...
  ko: {
    ...
    steps: ['<strong>이미지 업로드</strong> — "이미지 선택"을 클릭하거나 JPG, PNG 또는 WebP 파일을 드래그 앤 드롭하세요.','<strong>목표 크기 입력</strong> — 원하는 파일 크기를 킬로바이트로 입력하세요 (예: 100 KB, 200 KB).','<strong>리사이즈 클릭</strong> — 도구가 목표 크기에 맞게 압축합니다. 목표가 원본보다 큰 경우 최고 품질로 저장합니다.','<strong>다운로드</strong> — 리사이즈된 이미지를 기기에 저장하세요.'],
    h2b: '이미지를 정확한 KB 크기로 압축하는 최고의 무료 도구',
    body: '<p>폼 제출을 위해 100 KB 이하의 이미지가 필요하신가요? 비자 사진을 위해 정확히 200 KB가 필요하신가요? RelahConvert의 KB 리사이즈 도구는 스마트한 이진 탐색 압축을 사용하여 목표 파일 크기에 최대한 가깝게 맞춥니다 — 모두 브라우저 안에서 처리됩니다. 업로드 없음, 서버 없음, 완전 무료입니다.</p><p>이 도구는 세 가지 시나리오를 자동으로 처리합니다: 목표가 원본보다 작으면 압축하여 맞춥니다. 목표가 더 크면 최고 JPEG 품질로 다시 인코딩합니다. 이미지가 이미 목표 크기에 가까우면 원본을 그대로 다운로드합니다. 여권 사진 크기 요구사항, 정부 양식 업로드 제한, 이메일 첨부 용량 제한 등 특정 킬로바이트 크기의 이미지가 필요한 모든 상황에 완벽하게 작동합니다.</p>',
    ...
    faqs: [{ q: 'KB로 리사이즈란?', a: 'KB로 이미지 리사이즈란 이미지 파일을 킬로바이트 단위의 특정 파일 크기로 조정하는 것을 의미합니다. 축소의 경우 도구가 이미지를 압축합니다. 확대의 경우 최고 JPEG 품질로 다시 인코딩합니다. 예를 들어, 2 MB 사진을 허용 가능한 시각적 품질을 유지하면서 정확히 200 KB로 줄이는 것입니다.' },{ q: '200KB로 줄이려면?', a: '이미지를 업로드하고 목표 KB 필드에 200을 입력한 후 리사이즈를 클릭하세요. 도구가 자동으로 최적의 압축 수준을 찾아 이미지를 가능한 한 200 KB에 가깝게 만듭니다.' },{ q: '목표가 원본보다 크면 어떻게 되나요?', a: '원본 파일보다 큰 목표를 설정하면 도구가 최고 JPEG 품질로 이미지를 저장합니다. 달성 가능한 최대 크기가 경고로 표시됩니다. 이미지 크기는 동일하게 유지됩니다 — 인코딩 품질만 최대화됩니다.' },{ q: '여권 사진에 사용 가능?', a: '예 — 많은 국가에서 여권 및 비자 사진의 파일 크기를 특정 크기 이하로 요구합니다 (예: 100 KB, 200 KB, 300 KB). 사진을 업로드하고 필요한 크기를 입력한 후 다운로드하세요.' },{ q: '최소 크기가 있나요?', a: '최소 크기는 이미지의 크기와 내용에 따라 다릅니다. 매우 상세하거나 큰 이미지는 먼저 크기를 줄이지 않으면 특정 임계값 이하로 압축되지 않을 수 있습니다. 목표가 너무 작으면 도구가 자동으로 이미지 크기를 축소하여 목표에 도달합니다.' },{ q: '지원 포맷은?', a: 'JPG, PNG, WebP 이미지를 업로드할 수 있습니다. 최적의 압축 제어를 위해 출력은 항상 JPEG 형식입니다.' }],
    links: [{ href: '/compress', label: '압축' },{ href: '/resize', label: '크기 조정' },{ href: '/crop', label: '자르기' },{ href: '/passport-photo', label: '여권 사진' }],
  },
  zh: {
    h2a: '如何将图片调整为特定KB大小',
    steps: ['<strong>上传图片</strong> — 点击"选择图片"或拖放JPG、PNG或WebP文件。','<strong>输入目标大小</strong> — 输入您想要的文件大小（以千字节为单位，例如 100 KB、200 KB）。','<strong>点击调整</strong> — 工具压缩以达到目标大小。如果目标大于原始文件，则以最高质量保存。','<strong>下载</strong> — 将调整后的图片保存到设备。'],
    h2b: '将图片压缩到精确KB大小的最佳免费工具',
    body: '<p>需要100 KB以下的图片来提交表单？或者签证照片需要恰好200 KB？RelahConvert的KB调整工具使用智能二分搜索压缩，尽可能精确地达到您的目标文件大小 — 全部在浏览器中完成。无需上传、无需服务器、完全免费。</p><p>该工具自动处理三种场景：如果目标小于原始文件，则压缩以匹配。如果目标更大，则以最高JPEG质量重新编码。如果图片已接近目标大小，则直接下载原始文件。完美适用于护照照片尺寸要求、政府表单上传限制、电子邮件附件大小限制，以及任何需要特定千字节大小图片的场景。</p>',
    h3why: '为什么要按KB调整图片大小？',
    why: '许多网站、政府门户和应用程序要求图片低于特定文件大小。手动调整质量直到达到目标是一项繁琐的工作。这个工具自动化了整个过程 — 只需输入目标KB并下载即可。',
    faqs: [{ q: '什么是按KB调整图片？', a: '按KB调整图片大小意味着将图片文件调整到以千字节为单位的特定文件大小。缩小时，工具会压缩图片。增大时，工具以最高JPEG质量重新编码。例如，将一张2 MB的照片缩小到恰好200 KB，同时保持可接受的视觉质量。' },{ q: '如何缩小到200KB？', a: '上传您的图片，在目标KB字段中输入200，然后点击调整。工具会自动找到合适的压缩级别，使图片尽可能接近200 KB。' },{ q: '如果目标大于原始文件会怎样？', a: '如果您设置的目标大于原始文件，工具会以最高JPEG质量保存图片。警告将显示可达到的最大大小。图片尺寸保持不变 — 仅编码质量被最大化。' },{ q: '适用于护照和签证照片吗？', a: '是的 — 许多国家要求护照和签证照片低于特定文件大小（例如 100 KB、200 KB、300 KB）。上传您的照片，输入所需大小并下载。' },{ q: '有最小大小吗？', a: '最小值取决于图片的尺寸和内容。非常详细或尺寸较大的图片可能无法在不先缩小尺寸的情况下压缩到某个阈值以下。如果目标太小，工具会自动缩小图片尺寸以达到目标。' },{ q: '支持哪些格式？', a: '您可以上传JPG、PNG和WebP图片。为了实现最佳压缩控制，输出始终为JPEG格式。' }],
    links: [{ href: '/compress', label: '压缩' },{ href: '/resize', label: '调整大小' },{ href: '/crop', label: '裁剪' },{ href: '/passport-photo', label: '证件照' }],
  },
  'zh-TW': {
    h2a: '如何將圖片調整為特定KB大小',
    steps: ['<strong>上傳圖片</strong> — 點擊「選擇圖片」或拖放JPG、PNG或WebP檔案。','<strong>輸入目標大小</strong> — 輸入您想要的檔案大小（以千位元組為單位，例如 100 KB、200 KB）。','<strong>點擊調整</strong> — 工具壓縮以達到目標大小。如果目標大於原始檔案，則以最高品質儲存。','<strong>下載</strong> — 將調整後的圖片儲存到裝置。'],
    h2b: '將圖片壓縮到精確KB大小的最佳免費工具',
    body: '<p>需要100 KB以下的圖片來提交表單？或者簽證照片需要恰好200 KB？RelahConvert的KB調整工具使用智慧二分搜尋壓縮，盡可能精確地達到您的目標檔案大小 — 全部在瀏覽器中完成。無需上傳、無需伺服器、完全免費。</p><p>該工具自動處理三種場景：如果目標小於原始檔案，則壓縮以匹配。如果目標更大，則以最高JPEG品質重新編碼。如果圖片已接近目標大小，則直接下載原始檔案。完美適用於護照照片尺寸要求、政府表單上傳限制、電子郵件附件大小限制，以及任何需要特定千位元組大小圖片的場景。</p>',
    h3why: '為什麼要按KB調整圖片大小？',
    why: '許多網站、政府入口網站和應用程式要求圖片低於特定檔案大小。手動調整品質直到達到目標是一項繁瑣的工作。這個工具自動化了整個過程 — 只需輸入目標KB並下載即可。',
    faqs: [{ q: '什麼是按KB調整圖片？', a: '按KB調整圖片大小意味著將圖片檔案調整到以千位元組為單位的特定檔案大小。縮小時，工具會壓縮圖片。增大時，工具以最高JPEG品質重新編碼。例如，將一張2 MB的照片縮小到恰好200 KB，同時保持可接受的視覺品質。' },{ q: '如何縮小到200KB？', a: '上傳您的圖片，在目標KB欄位中輸入200，然後點擊調整。工具會自動找到合適的壓縮級別，使圖片盡可能接近200 KB。' },{ q: '如果目標大於原始檔案會怎樣？', a: '如果您設定的目標大於原始檔案，工具會以最高JPEG品質儲存圖片。警告將顯示可達到的最大大小。圖片尺寸保持不變 — 僅編碼品質被最大化。' },{ q: '適用於護照和簽證照片嗎？', a: '是的 — 許多國家要求護照和簽證照片低於特定檔案大小（例如 100 KB、200 KB、300 KB）。上傳您的照片，輸入所需大小並下載。' },{ q: '有最小大小嗎？', a: '最小值取決於圖片的尺寸和內容。非常詳細或尺寸較大的圖片可能無法在不先縮小尺寸的情況下壓縮到某個閾值以下。如果目標太小，工具會自動縮小圖片尺寸以達到目標。' },{ q: '支援哪些格式？', a: '您可以上傳JPG、PNG和WebP圖片。為了實現最佳壓縮控制，輸出始終為JPEG格式。' }],
  ...
  bg: {
    ...
    steps: [
      ...
      '<strong>Натиснете Промени</strong> — инструментът компресира, за да достигне целевия размер. Ако целевият размер е по-голям от оригинала, записва с максимално качество вместо това.',
    ...
    body: '<p>Нуждаете се от изображение под 100 KB за подаване на формуляр? Или точно 200 KB за снимка за виза? Инструментът „Промяна на размера в KB" на RelahConvert използва интелигентна компресия с двоично търсене, за да достигне целевия размер на файла възможно най-точно — изцяло във вашия браузър. Без качване, без сървър, напълно безплатно.</p><p>Инструментът обработва три сценария автоматично: ако целевият размер е по-малък от оригинала, компресира до съвпадение. Ако целевият размер е по-голям, прекодира с максимално качество JPEG. Ако изображението вече е близо до целевия размер, изтегля оригинала. Работи перфектно за изисквания за размер на паспортни снимки, лимити за качване на държавни формуляри, ограничения за прикачени файлове в имейли и всяка ситуация, в която имате нужда от изображение с определен размер в килобайти.</p>',
  ...
  ca: {
    ...
    steps: [
      ...
      '<strong>Feu clic a Redimensionar</strong> — l\'eina comprimeix per assolir la mida objectiu. Si la mida objectiu és més gran que l\'original, desa amb la qualitat màxima.',
    ...
    body: '<p>Necessiteu una imatge de menys de 100 KB per enviar un formulari? O exactament 200 KB per a una foto de visat? L\'eina „Redimensionar en KB" de RelahConvert utilitza compressió intel·ligent amb cerca binària per assolir la mida de fitxer objectiu tan precisament com sigui possible — tot dins del vostre navegador. Sense pujada, sense servidor, completament gratuït.</p><p>L\'eina gestiona tres escenaris automàticament: si la mida objectiu és més petita que l\'original, comprimeix per coincidir. Si la mida objectiu és més gran, recodifica amb qualitat JPEG màxima. Si la imatge ja és propera a la mida objectiu, descarrega l\'original. Funciona perfectament per a requisits de mida de fotos de passaport, límits de pujada de formularis governamentals, restriccions de fitxers adjunts de correu electrònic i qualsevol situació on necessiteu una imatge amb una mida específica en kilobytes.</p>',
  ...
  nl: {
    ...
    steps: [
      ...
      '<strong>Klik op Verkleinen</strong> — de tool comprimeert om je doelgrootte te bereiken. Als het doel groter is dan het origineel, wordt het opgeslagen met maximale kwaliteit.',
    ...
    body: '<p>Heb je een afbeelding onder de 100 KB nodig voor het indienen van een formulier? Of precies 200 KB voor een visumfoto? De tool „Verkleinen in KB" van RelahConvert gebruikt slimme binaire-zoekcompressie om je doelbestandsgrootte zo nauwkeurig mogelijk te bereiken — volledig in je browser. Geen upload, geen server, volledig gratis.</p><p>De tool verwerkt drie scenario\'s automatisch: als je doel kleiner is dan het origineel, comprimeert het om overeen te komen. Als het doel groter is, hercodeert het met maximale JPEG-kwaliteit. Als de afbeelding al dicht bij de doelgrootte is, downloadt het het origineel. Werkt perfect voor vereisten voor paspoortfoto-grootte, uploadlimieten van overheidsformulieren, beperkingen voor e-mailbijlagen en elke situatie waarin je een afbeelding met een specifieke kilobyte-grootte nodig hebt.</p>',
  ...
  el: {
    ...
    steps: [
      ...
      '<strong>Κλικ Αλλαγή μεγέθους</strong> — το εργαλείο συμπιέζει για να φτάσει τον στόχο σας. Αν ο στόχος είναι μεγαλύτερος από το πρωτότυπο, αποθηκεύει με μέγιστη ποιότητα αντ\' αυτού.',
    ...
    body: '<p>Χρειάζεστε εικόνα κάτω από 100 KB για υποβολή φόρμας; Ή ακριβώς 200 KB για φωτογραφία βίζας; Το εργαλείο „Αλλαγή μεγέθους σε KB" του RelahConvert χρησιμοποιεί έξυπνη συμπίεση δυαδικής αναζήτησης για να φτάσει το μέγεθος-στόχο του αρχείου όσο πιο κοντά γίνεται — όλα μέσα στο πρόγραμμα περιήγησής σας. Χωρίς μεταφόρτωση, χωρίς διακομιστή, εντελώς δωρεάν.</p><p>Το εργαλείο χειρίζεται τρία σενάρια αυτόματα: αν ο στόχος σας είναι μικρότερος από το πρωτότυπο, συμπιέζει για να ταιριάξει. Αν ο στόχος είναι μεγαλύτερος, επανακωδικοποιεί με μέγιστη ποιότητα JPEG. Αν η εικόνα είναι ήδη κοντά στο μέγεθος-στόχο, κατεβάζει το πρωτότυπο. Λειτουργεί τέλεια για απαιτήσεις μεγέθους φωτογραφιών διαβατηρίου, όρια μεταφόρτωσης κρατικών φορμών, περιορισμούς συνημμένων email και οποιαδήποτε κατάσταση όπου χρειάζεστε εικόνα σε συγκεκριμένο μέγεθος kilobyte.</p>',
  ...
  hi: {
    ...
    steps: [
      ...
      '<strong>बदलें पर क्लिक करें</strong> — टूल आपके लक्ष्य तक पहुँचने के लिए संपीड़ित करता है। यदि लक्ष्य मूल से बड़ा है, तो यह अधिकतम गुणवत्ता पर सहेजता है।',
    ...
    body: '<p>फॉर्म जमा करने के लिए 100 KB से कम की छवि चाहिए? या वीज़ा फोटो के लिए ठीक 200 KB? RelahConvert का KB में आकार बदलें टूल स्मार्ट बाइनरी-सर्च संपीड़न का उपयोग करता है ताकि आपके लक्ष्य फ़ाइल आकार को यथासंभव सटीक रूप से प्राप्त किया जा सके — सब कुछ आपके ब्राउज़र में। कोई अपलोड नहीं, कोई सर्वर नहीं, पूरी तरह मुफ्त।</p><p>टूल तीन परिदृश्यों को स्वचालित रूप से संभालता है: यदि आपका लक्ष्य मूल से छोटा है, तो यह मिलान के लिए संपीड़ित करता है। यदि लक्ष्य बड़ा है, तो यह अधिकतम JPEG गुणवत्ता पर पुन: एन्कोड करता है। यदि छवि पहले से लक्ष्य आकार के करीब है, तो यह मूल डाउनलोड करता है। पासपोर्ट फोटो आकार आवश्यकताओं, सरकारी फॉर्म अपलोड सीमाओं, ईमेल अटैचमेंट प्रतिबंधों और किसी भी स्थिति के लिए बिल्कुल सही काम करता है जहाँ आपको किसी विशिष्ट किलोबाइट आकार की छवि की आवश्यकता है।</p>',
  ...
  id: {
    ...
    steps: [
      ...
      '<strong>Klik Ubah Ukuran</strong> — alat ini mengompres untuk mencapai target Anda. Jika target lebih besar dari aslinya, alat menyimpan pada kualitas maksimum.',
  ...
  ms: {
    ...
    steps: [
      ...
      '<strong>Klik Ubah Saiz</strong> — alat ini memampatkan untuk mencapai sasaran anda. Jika sasaran lebih besar daripada asal, ia menyimpan pada kualiti maksimum.',
    ...
    body: '<p>Perlukan imej di bawah 100 KB untuk penghantaran borang? Atau tepat 200 KB untuk foto visa? Alat Ubah Saiz dalam KB daripada RelahConvert menggunakan pemampatan carian binari pintar untuk mencapai saiz fail sasaran anda setepat mungkin — semuanya dalam pelayar anda. Tanpa muat naik, tanpa pelayan, percuma sepenuhnya.</p><p>Alat ini mengendalikan tiga senario secara automatik: jika sasaran anda lebih kecil daripada asal, ia memampatkan untuk sepadan. Jika sasaran lebih besar, ia mengekod semula pada kualiti JPEG maksimum. Jika imej sudah hampir dengan saiz sasaran, ia memuat turun asal. Berfungsi sempurna untuk keperluan saiz foto pasport, had muat naik borang kerajaan, sekatan lampiran e-mel dan sebarang situasi di mana anda memerlukan imej pada saiz kilobait tertentu.</p>',
  ...
  pl: {
    ...
    steps: [
      ...
      '<strong>Kliknij Zmień rozmiar</strong> — narzędzie kompresuje, aby osiągnąć cel. Jeśli cel jest większy niż oryginał, zapisuje w maksymalnej jakości.',
  ...
  sv: {
    ...
    steps: [
      ...
      '<strong>Klicka på Ändra storlek</strong> — verktyget komprimerar för att nå ditt mål. Om målet är större än originalet sparas det med maximal kvalitet istället.',
    ...
    body: '<p>Behöver du en bild under 100 KB för en formulärinlämning? Eller exakt 200 KB för ett visumfoto? RelahConverts verktyg „Ändra storlek i KB" använder smart binärsökningskomprimering för att nå din målfilstorlek så nära som möjligt — helt i din webbläsare. Ingen uppladdning, ingen server, helt gratis.</p><p>Verktyget hanterar tre scenarier automatiskt: om ditt mål är mindre än originalet komprimeras det för att matcha. Om målet är större omkodas det med maximal JPEG-kvalitet. Om bilden redan är nära målstorleken laddas originalet ner. Fungerar perfekt för krav på passfotostorlek, uppladdningsgränser för myndighetsformulär, begränsningar för e-postbilagor och alla situationer där du behöver en bild med en specifik kilobyte-storlek.</p>',
  ...
  th: {
    ...
    steps: [
      ...
      '<strong>คลิกปรับขนาด</strong> — เครื่องมือบีบอัดเพื่อให้ได้เป้าหมายของคุณ หากเป้าหมายใหญ่กว่าต้นฉบับ จะบันทึกที่คุณภาพสูงสุดแทน',
    ...
    body: '<p>ต้องการรูปภาพต่ำกว่า 100 KB สำหรับการส่งแบบฟอร์ม? หรือพอดี 200 KB สำหรับรูปถ่ายวีซ่า? เครื่องมือ "ปรับขนาดเป็น KB" ของ RelahConvert ใช้การบีบอัดค้นหาแบบไบนารีอัจฉริยะเพื่อให้ได้ขนาดไฟล์เป้าหมายของคุณใกล้เคียงที่สุด — ทั้งหมดในเบราว์เซอร์ของคุณ ไม่ต้องอัปโหลด ไม่มีเซิร์ฟเวอร์ ฟรีทั้งหมด</p><p>เครื่องมือจัดการสามสถานการณ์โดยอัตโนมัติ: หากเป้าหมายของคุณเล็กกว่าต้นฉบับ จะบีบอัดให้ตรงกัน หากเป้าหมายใหญ่กว่า จะเข้ารหัสใหม่ที่คุณภาพ JPEG สูงสุด หากรูปภาพใกล้เคียงกับขนาดเป้าหมายอยู่แล้ว จะดาวน์โหลดต้นฉบับ ทำงานได้อย่างสมบูรณ์แบบสำหรับข้อกำหนดขนาดรูปถ่ายพาสปอร์ต ขีดจำกัดการอัปโหลดแบบฟอร์มราชการ ข้อจำกัดไฟล์แนบอีเมล และทุกสถานการณ์ที่คุณต้องการรูปภาพที่ขนาดกิโลไบต์เฉพาะ</p>',
  ...
  tr: {
    ...
    steps: [
      ...
      '<strong>Boyutlandır\'a tıklayın</strong> — araç hedefinize ulaşmak için sıkıştırır. Hedef orijinalden büyükse, maksimum kalitede kaydeder.',
  ...
  uk: {
    ...
    steps: [
      ...
      '<strong>Натисніть Змінити</strong> — інструмент стискає для досягнення вашої цілі. Якщо ціль більша за оригінал, зберігає з максимальною якістю замість цього.',
    ...
    body: '<p>Потрібне зображення менше 100 КБ для подання форми? Або точно 200 КБ для фото на візу? Інструмент „Змінити розмір у КБ" від RelahConvert використовує розумне стиснення з бінарним пошуком для досягнення цільового розміру файлу якомога точніше — повністю у вашому браузері. Без завантаження, без сервера, повністю безкоштовно.</p><p>Інструмент автоматично обробляє три сценарії: якщо ваша ціль менша за оригінал, стискає для відповідності. Якщо ціль більша, перекодовує з максимальною якістю JPEG. Якщо зображення вже близьке до цільового розміру, завантажує оригінал. Ідеально працює для вимог щодо розміру фото на паспорт, обмежень завантаження державних форм, обмежень вкладень електронної пошти та будь-якої ситуації, де вам потрібне зображення певного розміру в кілобайтах.</p>',
  ...
  vi: {
    ...
    steps: [
      ...
      '<strong>Nhấp Thay đổi kích thước</strong> — công cụ nén để đạt mục tiêu của bạn. Nếu mục tiêu lớn hơn bản gốc, công cụ lưu ở chất lượng tối đa thay thế.',
      '<strong>Tải về</strong> — lưu ảnh đã thay đổi kích thước vào thiết bị của bạn.'
    ],
    h2b: 'Công cụ miễn phí tốt nhất để nén ảnh đúng KB',
    body: '<p>Cần ảnh dưới 100 KB để nộp biểu mẫu? Hoặc đúng 200 KB cho ảnh thị thực? Công cụ Thay đổi kích thước theo KB của RelahConvert sử dụng nén tìm kiếm nhị phân thông minh để đạt kích thước tệp mục tiêu của bạn chính xác nhất có thể — tất cả trong trình duyệt của bạn. Không cần tải lên, không có máy chủ, hoàn toàn miễn phí.</p><p>Công cụ xử lý ba tình huống tự động: nếu mục tiêu của bạn nhỏ hơn bản gốc, nó nén để khớp. Nếu mục tiêu lớn hơn, nó mã hóa lại ở chất lượng JPEG tối đa. Nếu ảnh đã gần kích thước mục tiêu, nó tải xuống bản gốc. Hoạt động hoàn hảo cho các yêu cầu kích thước ảnh hộ chiếu, giới hạn tải lên biểu mẫu chính phủ, hạn chế tệp đính kèm email và bất kỳ tình huống nào bạn cần ảnh ở kích thước kilobyte cụ thể.</p>',
