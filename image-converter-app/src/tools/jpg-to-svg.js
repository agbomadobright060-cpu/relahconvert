...
style.textContent = `
  ...
  #svgWidth{width:90px;padding:6px 10px;border:1.5px solid var(--border-light);border-radius:8px;font-size:13px;font-family:'DM Sans',sans-serif;color:var(--text-primary);outline:none;}
...
zipBtn.addEventListener('click', async () => {
  ...
  try {
    ...
    window.rcShowSaveButton?.(zipBtn.parentElement, zipBlob, 'svg-files.zip', 'jpg-to-svg')
