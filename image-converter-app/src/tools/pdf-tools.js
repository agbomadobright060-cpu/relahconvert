...
const svgIcons = {
  ...
  'rotate-pdf':       { svg: `<svg viewBox="0 0 42 42" fill="none"><g transform="translate(2.8 2.8) scale(0.867)"><rect x="6" y="6" width="30" height="30" rx="3" fill="#16A34A"/><path d="M30 21a9 9 0 11-3-6.7" stroke="#fff" stroke-width="2.4" stroke-linecap="round" fill="none"/><path d="M30 13v6h-6" stroke="#fff" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" fill="none"/></g></svg>` },
  'compress-pdf':     { svg: `<svg viewBox="0 0 42 42" fill="none"><g transform="translate(4.93 4.93) scale(0.765)"><rect x="4" y="4" width="13" height="13" rx="2.5" fill="#16A34A"/><rect x="25" y="4" width="13" height="13" rx="2.5" fill="#16A34A"/><rect x="4" y="25" width="13" height="13" rx="2.5" fill="#16A34A"/><rect x="25" y="25" width="13" height="13" rx="2.5" fill="#16A34A"/><path d="M9 9l4 4M33 9l-4 4M9 33l4-4M33 33l-4-4" stroke="#fff" stroke-width="1.8" stroke-linecap="round"/></g></svg>` },
  'reorder-pdf':      { svg: `<svg viewBox="0 0 42 42" fill="none"><g transform="translate(2.8 2.8) scale(0.867)"><rect x="6" y="7" width="30" height="7" rx="2" fill="#7C3AED"/><rect x="6" y="17.5" width="30" height="7" rx="2" fill="#7C3AED" opacity="0.55"/><rect x="6" y="28" width="30" height="7" rx="2" fill="#7C3AED"/><circle cx="32" cy="10.5" r="1.4" fill="#fff"/><circle cx="32" cy="31.5" r="1.4" fill="#fff"/></g></svg>` },
  ...
  'add-page-numbers': { svg: `<svg viewBox="0 0 42 42" fill="none"><g transform="translate(2.8 2.8) scale(0.867)"><rect x="6" y="6" width="30" height="30" rx="3" fill="#EA580C"/><path d="M12 13h18M12 18h18M12 23h12" stroke="#fff" stroke-width="2" stroke-linecap="round"/><circle cx="21" cy="31" r="4" fill="#fff"/><text x="21" y="33.5" font-family="Arial,sans-serif" font-size="6" font-weight="800" fill="#EA580C" text-anchor="middle">1</text></g></svg>` },
  'watermark-pdf':    { svg: `<svg viewBox="0 0 42 42" fill="none"><g transform="translate(2.8 2.8) scale(0.867)"><rect x="6" y="6" width="30" height="30" rx="3" fill="#6366F1"/><path d="M11 12h20M11 17h20M11 22h20M11 27h13" stroke="#fff" stroke-width="1.6" stroke-linecap="round" opacity="0.5"/><g transform="rotate(-22 25 25)"><rect x="14" y="20" width="22" height="10" rx="1.5" fill="none" stroke="#fff" stroke-width="1.8"/><text x="25" y="27.5" font-family="Arial,sans-serif" font-size="6" font-weight="800" fill="#fff" text-anchor="middle" letter-spacing="0.5">MARK</text></g></g></svg>` },
  'crop-pdf':         { svg: `<svg viewBox="0 0 42 42" fill="none"><g transform="translate(2.8 2.8) scale(0.867)"><rect x="6" y="6" width="30" height="30" rx="3" fill="#0D9488"/><path d="M14 9v9M9 14h9M28 33v-9M33 28h-9" stroke="#fff" stroke-width="2.4" stroke-linecap="round"/><rect x="14" y="14" width="14" height="14" stroke="#fff" stroke-width="1.6" fill="none" opacity="0.7"/></g></svg>` },
  'protect-pdf':      { svg: `<svg viewBox="0 0 42 42" fill="none"><g transform="translate(2.8 2.8) scale(0.867)"><rect x="6" y="6" width="30" height="30" rx="3" fill="#059669"/><rect x="13" y="20" width="16" height="12" rx="1.8" fill="#fff"/><path d="M16 20v-3a5 5 0 0110 0v3" stroke="#fff" stroke-width="2" stroke-linecap="round" fill="none"/><circle cx="21" cy="26" r="1.8" fill="#059669"/></g></svg>` },
  'unlock-pdf':       { svg: `<svg viewBox="0 0 42 42" fill="none"><g transform="translate(2.8 2.8) scale(0.867)"><rect x="6" y="6" width="30" height="30" rx="3" fill="#DC2626"/><rect x="13" y="20" width="16" height="12" rx="1.8" fill="#fff"/><path d="M16 20v-3a5 5 0 019-3" stroke="#fff" stroke-width="2" stroke-linecap="round" fill="none"/><circle cx="21" cy="26" r="1.8" fill="#DC2626"/></g></svg>` },
