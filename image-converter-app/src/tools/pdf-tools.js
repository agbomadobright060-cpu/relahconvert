...
const svgIcons = {
  ...
  'word-to-pdf':       { svg: `<svg viewBox="0 0 42 42" fill="none"><rect x="4" y="4" width="26" height="26" rx="4" fill="#2563EB"/><text x="17" y="23" font-family="Arial,sans-serif" font-size="14" font-weight="800" fill="#fff" text-anchor="middle">W</text><rect x="19" y="19" width="19" height="19" rx="3" fill="#DC2626" stroke="#fff" stroke-width="1.8"/><text x="28.5" y="32" font-family="Arial,sans-serif" font-size="7" font-weight="800" fill="#fff" text-anchor="middle">PDF</text></svg>` },
  'excel-to-pdf':      { svg: `<svg viewBox="0 0 42 42" fill="none"><rect x="4" y="4" width="26" height="26" rx="4" fill="#16A34A"/><text x="17" y="23" font-family="Arial,sans-serif" font-size="14" font-weight="800" fill="#fff" text-anchor="middle">X</text><rect x="19" y="19" width="19" height="19" rx="3" fill="#DC2626" stroke="#fff" stroke-width="1.8"/><text x="28.5" y="32" font-family="Arial,sans-serif" font-size="7" font-weight="800" fill="#fff" text-anchor="middle">PDF</text></svg>` },
}
