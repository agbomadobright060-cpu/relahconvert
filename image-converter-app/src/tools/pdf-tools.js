...
const svgIcons = {
  'merge-pdf':        { svg: `<svg viewBox="0 0 42 42" fill="none"><rect x="5" y="14" width="18" height="18" rx="3" fill="#E94B2C"/><rect x="19" y="6" width="18" height="18" rx="3" fill="#E94B2C"/><path d="M22 30l-3-3h3v-3" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M20 8l3 3h-3v3" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>` },
  'split-pdf':        { svg: `<svg viewBox="0 0 42 42" fill="none"><rect x="5" y="14" width="18" height="18" rx="3" fill="#F97316"/><rect x="19" y="6" width="18" height="18" rx="3" fill="#F97316"/><path d="M9 30l-1-4 4 1" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M33 8l1 4-4-1" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>` },
