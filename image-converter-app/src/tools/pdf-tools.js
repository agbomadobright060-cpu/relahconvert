...
style.textContent = `
  ...
  .pdf-tool-card .icon{width:38px;height:38px;display:flex;align-items:center;justify-content:center;margin-bottom:14px;flex-shrink:0;}
  .pdf-tool-card .icon svg{width:38px;height:38px;display:block;}
