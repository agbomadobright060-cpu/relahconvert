...
const svgIcons = {
  'merge-pdf':        { svg: `<svg viewBox="0 0 42 42" fill="none"><rect x="5" y="14" width="18" height="18" rx="3" fill="#E94B2C"/><rect x="19" y="6" width="18" height="18" rx="3" fill="#E94B2C"/><path d="M10 27l10-10M17 17h3v3" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M32 11l-10 10M25 21h-3v-3" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>` },
  'split-pdf':        { svg: `<svg viewBox="0 0 42 42" fill="none"><rect x="5" y="14" width="18" height="18" rx="3" fill="#F97316"/><rect x="19" y="6" width="18" height="18" rx="3" fill="#F97316"/><path d="M20 19l-10 10M10 26v3h3" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M22 19l10-10M32 12v-3h-3" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>` },
  ...
  'extract-pdf':      { svg: `<svg viewBox="0 0 42 42" fill="none"><rect x="5" y="14" width="18" height="18" rx="3" fill="#0891B2"/><rect x="19" y="6" width="18" height="18" rx="3" fill="#0891B2"/><path d="M9 19h10M9 23h7M9 27h10" stroke="#fff" stroke-width="1.6" stroke-linecap="round"/><path d="M28 11v6M25 14l3 3 3-3" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>` },
  'remove-pdf':       { svg: `<svg viewBox="0 0 42 42" fill="none"><rect x="5" y="14" width="18" height="18" rx="3" fill="#E11D48"/><rect x="19" y="6" width="18" height="18" rx="3" fill="#E11D48"/><path d="M9 19h10M9 23h7M9 27h10" stroke="#fff" stroke-width="1.6" stroke-linecap="round"/><path d="M24 10l8 8M32 10l-8 8" stroke="#fff" stroke-width="2" stroke-linecap="round"/></svg>` },
  ...
  'extract-images-pdf':{ svg: `<svg viewBox="0 0 42 42" fill="none"><rect x="5" y="14" width="18" height="18" rx="3" fill="#9333EA"/><rect x="19" y="6" width="18" height="18" rx="3" fill="#9333EA"/><path d="M9 19h10M9 23h7M9 27h10" stroke="#fff" stroke-width="1.6" stroke-linecap="round"/><circle cx="25" cy="12" r="1.6" fill="#fff"/><path d="M21 19l3-3 2.5 2.5L29 16l4 4" stroke="#fff" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>` },
}
