...
document.querySelector('#app').innerHTML = `
  <div id="mainContainer" style="max-width:700px; margin:32px auto; padding:0 16px 60px; font-family:'DM Sans',sans-serif; transition:max-width 0.3s;">
    ...
    <div id="uploadArea" style="margin-bottom:16px;">
      ...
      <label for="fileInput" id="dropZone" style="display:flex;flex-direction:column;align-items:center;justify-content:center;margin-top:16px;padding:48px 24px;border:2px dashed var(--border-light);border-radius:14px;cursor:pointer;transition:border-color 0.2s,background 0.2s;" onmouseover="this.style.borderColor='var(--accent)';this.style.background='var(--accent-bg)'" onmouseout="this.style.borderColor='var(--border-light)';this.style.background='transparent'">
        ...
        <span style="font-size:14px;color:var(--text-secondary);margin-top:10px;font-family:'DM Sans',sans-serif;font-weight:600;">Drop images here</span>
        <span style="font-size:12px;color:var(--text-muted);margin-top:4px;font-family:'DM Sans',sans-serif;">JPG, PNG, WebP — up to 25 files</span>
      </label>
    </div>
