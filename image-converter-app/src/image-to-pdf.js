...
export function initImageToPdf({ slug: _slug } = {}) {
  ...
  const pdfTitles = { en: { jpg: 'Photo to PDF', png: 'Screenshot to PDF' }, fr: { jpg: 'Photo en PDF', png: 'Capture en PDF' }, es: { jpg: 'Foto a PDF', png: 'Captura a PDF' }, pt: { jpg: 'Foto para PDF', png: 'Captura para PDF' }, de: { jpg: 'Foto zu PDF', png: 'Screenshot zu PDF' }, ar: { jpg: 'صورة إلى PDF', png: 'لقطة شاشة إلى PDF' } }
