...
export function injectHeader() {
  ...
  const svgIcons = {
    ...
    'website-screenshot':   { bg: '#E0F2FE', svg: `<svg viewBox="0 0 40 40" fill="none"><rect x="4" y="8" width="32" height="24" rx="3" fill="#0EA5E9" opacity="0.2" stroke="#0EA5E9" stroke-width="1.5"/><rect x="4" y="8" width="32" height="7" rx="3" fill="#0EA5E9" opacity="0.35"/><circle cx="9" cy="11.5" r="1.5" fill="#fff"/><circle cx="14" cy="11.5" r="1.5" fill="#fff"/><circle cx="19" cy="11.5" r="1.5" fill="#fff"/><rect x="8" y="19" width="24" height="2" rx="1" fill="#0EA5E9" opacity="0.4"/><rect x="8" y="24" width="16" height="2" rx="1" fill="#0EA5E9" opacity="0.4"/></svg>` },
  }
